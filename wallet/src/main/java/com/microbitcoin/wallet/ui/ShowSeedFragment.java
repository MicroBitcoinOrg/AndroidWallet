...
public class ShowSeedFragment extends Fragment {
    ...
    DialogFragment passwordDialog = new MyUnlockWalletDialog(this);

    public static class MyUnlockWalletDialog extends UnlockWalletDialog {
        private ShowSeedFragment f;

        public MyUnlockWalletDialog(ShowSeedFragment f) {
            this.f = f;
        }
