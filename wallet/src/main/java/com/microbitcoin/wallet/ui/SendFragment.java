...
import com.microbitcoin.wallet.tasks.MarketInfoPollTask;
...
import static com.microbitcoin.core.coins.Value.canCompare;
import static com.microbitcoin.wallet.ExchangeRatesProvider.getRates;
import static com.microbitcoin.wallet.util.UiUtils.setGone;
import static com.microbitcoin.wallet.util.UiUtils.setVisible;
    ...
    private final LoaderCallbacks<Cursor> rateLoaderCallbacks = new LoaderManager.LoaderCallbacks<Cursor>() {
        ...
        public void onLoadFinished(final Loader<Cursor> loader, final Cursor data) {
            if (data != null && data.getCount() > 0) {
                HashMap<String, com.microbitcoin.core.util.ExchangeRate> rates = new HashMap<>(data.getCount());
                data.moveToFirst();
                do {
