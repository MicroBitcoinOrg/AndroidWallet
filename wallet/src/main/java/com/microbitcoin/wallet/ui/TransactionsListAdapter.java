...
import com.microbitcoin.core.wallet.AbstractWallet;
import com.microbitcoin.wallet.AddressBookProvider;
import com.microbitcoin.wallet.R;
import com.microbitcoin.wallet.ui.widget.CurrencyTextView;
...
public class TransactionsListAdapter extends BaseAdapter {
    ...
    public TransactionsListAdapter(final Context context, @Nonnull final AbstractWallet walletPocket) {
        ...
        colorLessSignificant = res.getColor(R.color.white_almost);
        colorInsignificant = res.getColor(R.color.white_almost);
...
//        final TextView rowDate = (TextView) row.findViewById(R.id.transaction_row_time);
        ...
        if (confidenceType == ConfidenceType.PENDING) {
            ...
            rowDirectionFontIcon.setTextColor(0xff000000);
