package com.microbitcoin.wallet.util;
...
public class Qr {
    ...
    private static final int darkColor = 0xffffffff;
    private static final int lightColor = 0xff000000;
        ...
        try {
            ...
            for (int y = 0; y < height; y++) {
                ...
                for (int x = 0; x < width; x++) {
                    pixels[offset + x] = result.get(x, y) ? lightColor : darkColor;
                }
            }
