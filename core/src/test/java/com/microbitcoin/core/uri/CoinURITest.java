package com.microbitcoin.core.uri;
...
import com.microbitcoin.core.coins.BitcoinMain;
import com.microbitcoin.core.coins.BitcoinTest;
import com.microbitcoin.core.coins.CoinType;
import com.microbitcoin.core.coins.DashMain;
import com.microbitcoin.core.coins.DogecoinMain;
import com.microbitcoin.core.coins.LitecoinMain;
import com.microbitcoin.core.coins.NuBitsMain;
import com.microbitcoin.core.coins.NuSharesMain;
import com.microbitcoin.core.coins.PeercoinMain;
...
//        assertEquals(BTC, uri.getType());
    ...
    public void testAddressRequest() throws Exception {
        ...
        assertNull(uri.getAddress());
        assertEquals(BTC, uri.getType());
        assertEquals("https://microbitcoin.com", uri.getAddressRequestUri().toString());
        assertEquals("https://microbitcoin.com?address=" + MAINNET_GOOD_ADDRESS,
        ...
        assertNull(uri.getAddress());
        assertEquals(BTC, uri.getType());
        assertEquals("https://microbitcoin.com/some-path?abc=xyz", uri.getAddressRequestUri().toString());
        assertEquals("https://microbitcoin.com/some-path?abc=xyz&address=" + MAINNET_GOOD_ADDRESS,
                uri.getAddressRequestUriResponse(MAINNET_GOOD_ADDRESS).toString());
        ...
        // NuShares
        goodAddressStr = new Address(NSR, hash160).toString();
