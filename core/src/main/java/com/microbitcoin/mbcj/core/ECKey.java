...
import com.microbitcoin.mbcj.bitcoin.NativeSecp256k1;
import com.microbitcoin.mbcj.bitcoin.NativeSecp256k1Util;
import com.microbitcoin.mbcj.bitcoin.Secp256k1Context;
...
import com.microbitcoin.mbcj.crypto.LinuxSecureRandom;
import com.microbitcoin.mbcj.crypto.TransactionSignature;
import com.microbitcoin.mbcj.wallet.Protos;
...
public class ECKey implements EncryptableItem {
     ...
     *
     * @throws com.microbitcoin.mbcj.core.ECKey.MissingPrivateKeyException if the private key is missing or encrypted.
     */
    public byte[] toASN1() {
        try {
     ...
     * usually encoded using ASN.1 format, so you want {@link com.microbitcoin.mbcj.core.ECKey.ECDSASignature#toASN1()}
    ...
    /**
     * Signs the given hash and returns the R and S components as BigIntegers. In the Bitcoin protocol, they are
     * usually encoded using DER format, so you want {@link com.microbitcoin.mbcj.core.ECKey.ECDSASignature#encodeToDER()}
     ...
     *
     * @throws com.microbitcoin.mbcj.core.ECKey.MissingPrivateKeyException if the private key bytes are missing/encrypted.
     */
     ...
     * the {@link com.microbitcoin.mbcj.core.DumpedPrivateKey#toString()} method to get the string.
     *
