...
import static com.microbitcoin.mbcj.core.Sha256Hash.hashTwice;
...
public class Block extends Message implements Serializable{
    /**
     ...
     *
     * <p>The half-life is controlled by {@link com.microbitcoin.mbcj.core.NetworkParameters#getSubsidyDecreaseBlockCount()}.
     * </p>
     */
    ...
    protected void parse() throws ProtocolException {
        ...
        nonce = readUint32();
        hash = Sha256Hash.wrapReversed(hashTwice(payload, offset, cursor - offset));
    ...
    private Sha256Hash calculateHash() {
        try {
            ...
            writeHeader(bos);
            return Sha256Hash.wrapReversed(hashTwice(bos.toByteArray()));
        } catch (IOException e) {
     ...
     * {@link com.microbitcoin.mbcj.core.Block#getDifficultyTargetAsInteger()}. Note that this is <b>not</b> the same as
