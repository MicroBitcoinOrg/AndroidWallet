...
import com.microbitcoin.mbcj.core.listeners.*;
 ...
 * {@link com.microbitcoin.mbcj.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link com.microbitcoin.mbcj.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link com.microbitcoin.mbcj.net.NioClientManager#openConnection(java.net.SocketAddress, StreamConnection)}
     * or
     * {@link com.microbitcoin.mbcj.net.NioClient#NioClient(java.net.SocketAddress, StreamConnection, int)}.</p>
     * <p>
    ...
    /**
     * <p>Construct a peer that reads/writes from the given block chain. Transactions stored in a {@link com.microbitcoin.mbcj.core.TxConfidenceTable}
     ...
     * Once the pong is received the value returned by {@link com.microbitcoin.mbcj.core.Peer#getLastPingTime()} is
     * updated.
     *
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link com.microbitcoin.mbcj.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link com.microbitcoin.mbcj.core.Peer#ping()} has never
