...
import com.microbitcoin.mbcj.core.listeners.FeeFilterMessage;
import com.microbitcoin.mbcj.core.listeners.SendHeadersMessage;
...
import static com.microbitcoin.mbcj.core.Utils.*;
...
public class BitcoinSerializer extends MessageSerializer implements Serializable{
    ...
    public static class BitcoinPacketHeader implements Serializable{
