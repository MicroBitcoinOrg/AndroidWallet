...
package com.microbitcoin.mbcj.core;
...
import com.microbitcoin.mbcj.core.listeners.AbstractPeerEventListener;
import com.microbitcoin.mbcj.core.listeners.BlocksDownloadedEventListener;
import com.microbitcoin.mbcj.core.listeners.ChainDownloadStartedEventListener;
import com.microbitcoin.mbcj.core.listeners.DownloadProgressTracker;
import com.microbitcoin.mbcj.core.listeners.GetDataEventListener;
import com.microbitcoin.mbcj.core.listeners.OnTransactionBroadcastListener;
import com.microbitcoin.mbcj.core.listeners.PeerConnectedEventListener;
import com.microbitcoin.mbcj.core.listeners.PeerDataEventListener;
import com.microbitcoin.mbcj.core.listeners.PeerDisconnectedEventListener;
import com.microbitcoin.mbcj.core.listeners.PeerDiscoveredEventListener;
import com.microbitcoin.mbcj.core.listeners.PreMessageReceivedEventListener;
import com.microbitcoin.mbcj.crypto.DRMWorkaround;
import com.microbitcoin.mbcj.net.BlockingClientManager;
import com.microbitcoin.mbcj.net.ClientConnectionManager;
import com.microbitcoin.mbcj.net.FilterMerger;
import com.microbitcoin.mbcj.net.NioClientManager;
import com.microbitcoin.mbcj.net.discovery.HttpDiscovery;
import com.microbitcoin.mbcj.net.discovery.MultiplexingDiscovery;
import com.microbitcoin.mbcj.net.discovery.PeerDiscovery;
import com.microbitcoin.mbcj.net.discovery.PeerDiscoveryException;
import com.microbitcoin.mbcj.net.discovery.TorDiscovery;
import com.microbitcoin.mbcj.script.Script;
import com.microbitcoin.mbcj.utils.ContextPropagatingThreadFactory;
import com.microbitcoin.mbcj.utils.ExponentialBackoff;
...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * {@link com.microbitcoin.mbcj.core.listeners.PeerConnectionEventListener} and use the onPeerConnected/onPeerDisconnected methods.
     */
     ...
     * Use {@link com.microbitcoin.mbcj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link com.microbitcoin.mbcj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link com.microbitcoin.mbcj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link com.microbitcoin.mbcj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link com.microbitcoin.mbcj.core.TransactionBroadcast#future()} method will be completed. If anything goes
     ...
     * <p>
     * <p>The returned {@link com.microbitcoin.mbcj.core.TransactionBroadcast} object can be used to get progress feedback,
     ...
     * times are available via {@link com.microbitcoin.mbcj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link com.microbitcoin.mbcj.core.Peer#ping()}.
     */
