...
import com.microbitcoin.mbcj.script.ScriptOpCodes;
import com.microbitcoin.mbcj.utils.ExchangeRate;
...
import static com.microbitcoin.mbcj.core.Utils.uint32ToByteStreamLE;
import static com.microbitcoin.mbcj.core.Utils.uint64ToByteStreamLE;
...
public class Transaction extends ChildMessage implements Serializable{
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, com.microbitcoin.mbcj.script.Script, ECKey, com.microbitcoin.mbcj.core.Transaction.SigHash, boolean)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], com.microbitcoin.mbcj.core.Transaction.SigHash, boolean)}
    ...
    /**
     * Returns the confidence object for this transaction from the {@link com.microbitcoin.mbcj.core.TxConfidenceTable}
