...
import com.microbitcoin.mbcj.core.listeners.BlockChainListener;
...
import com.microbitcoin.mbcj.utils.VersionTally;
 ...
 * <p>
 * <p>An AbstractBlockChain implementation must be connected to a BlockStore implementation. The chain object
 ...
 * the lightweight SPV mode, a {@link com.microbitcoin.mbcj.store.SPVBlockStore} is the right choice.</p>
 * <p>
 ...
 * {@link com.microbitcoin.mbcj.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to
...
public abstract class AbstractBlockChain {
    ...
    class OrphanBlock {
        ...
        OrphanBlock(Block block, @Nullable List<Sha256Hash> filteredTxHashes, @Nullable Map<Sha256Hash, Transaction> filteredTxn) {
            ...
            checkArgument((block.transactions == null && filtered)
