...
/**
 * <p>A KeyChainGroup is used by the {@link com.microbitcoin.mbcj.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
    ...
    public static KeyChainGroup fromProtobufEncrypted(NetworkParameters params, List<Protos.Key> keys, KeyCrypter crypter, com.microbitcoin.mbcj.wallet.KeyChainFactory factory) throws UnreadableWalletException {
