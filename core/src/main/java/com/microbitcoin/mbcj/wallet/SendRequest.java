...
import com.microbitcoin.mbcj.wallet.KeyChain.KeyPurpose;
import com.microbitcoin.mbcj.wallet.Wallet.MissingSigsMode;
...
public class SendRequest {
     ...
     * (its value is ignored and set to {@link com.microbitcoin.mbcj.wallet.Wallet#getBalance()} - the fees required
    ...
    /**
     * If not null, the {@link com.microbitcoin.mbcj.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
