...
package com.microbitcoin.mbcj.wallet.listeners;
...
public interface WalletCoinsReceivedEventListener {
     ...
     * transaction receives its first confirmation, register a TransactionConfidence event listener using
     * the object retrieved via {@link com.microbitcoin.mbcj.core.Transaction#getConfidence()}. It's safe to modify the
