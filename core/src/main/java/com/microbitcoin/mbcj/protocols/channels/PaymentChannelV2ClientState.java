...
import com.microbitcoin.mbcj.wallet.AllowUnconfirmedCoinSelector;
import com.microbitcoin.mbcj.wallet.SendRequest;
...
public class PaymentChannelV2ClientState extends PaymentChannelClientState {
    private static final Logger log = LoggerFactory.getLogger(com.microbitcoin.mbcj.protocols.channels.PaymentChannelV1ClientState.class);
