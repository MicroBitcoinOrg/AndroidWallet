...
public final class ServerState {
    ...
    public interface StoredServerPaymentChannelsOrBuilder extends
         ...
         */
        List<StoredServerPaymentChannel>
        getChannelsList();
    ...
    public static final class StoredServerPaymentChannels extends
        ...
        private StoredServerPaymentChannels(
            ...
            try {
                    ...
                    switch (tag) {
                        ...
                        case 10: {
                            if (!((mutable_bitField0_ & 0x00000001) == 0x00000001)) {
                                channels_ = new ArrayList<StoredServerPaymentChannel>();
                ...
                if (((mutable_bitField0_ & 0x00000001) == 0x00000001)) {
                    channels_ = Collections.unmodifiableList(channels_);
                }
        ...
        public static Parser<StoredServerPaymentChannels> PARSER =
                new AbstractParser<StoredServerPaymentChannels>() {
        ...
        private List<ServerState.StoredServerPaymentChannel> channels_;
         ...
         * <code>repeated .paymentchannels.StoredServerPaymentChannel channels = 1;</code>
         */
        public List<? extends ServerState.StoredServerPaymentChannelOrBuilder>
        getChannelsOrBuilderList() {
            return channels_;
        }
        ...
        private void initFields() {
            channels_ = Collections.emptyList();
        }
        ...
        public static final class Builder extends
            ...
            private void ensureChannelsIsMutable() {
                if (!((bitField0_ & 0x00000001) == 0x00000001)) {
                    channels_ = new ArrayList<ServerState.StoredServerPaymentChannel>(channels_);
            ...
            public List<ServerState.StoredServerPaymentChannel> getChannelsList() {
                if (channelsBuilder_ == null) {
                    return Collections.unmodifiableList(channels_);
                } else {
             ...
             * <code>repeated .paymentchannels.StoredServerPaymentChannel channels = 1;</code>
             */
            public List<ServerState.StoredServerPaymentChannel.Builder>
            ...
            getChannelsFieldBuilder() {
                if (channelsBuilder_ == null) {
                    channelsBuilder_ = new RepeatedFieldBuilder<
                            ServerState.StoredServerPaymentChannel, ServerState.StoredServerPaymentChannel.Builder, ServerState.StoredServerPaymentChannelOrBuilder>(
                            channels_,
    ...
    public static final class StoredServerPaymentChannel extends
        ...
        public static Parser<StoredServerPaymentChannel> PARSER =
                new AbstractParser<StoredServerPaymentChannel>() {
        ...
        private void initFields() {
            bestValueToMe_ = 0L;
            bestValueSignature_ = ByteString.EMPTY;
            refundTransactionUnlockTimeSecs_ = 0L;
            contractTransaction_ = ByteString.EMPTY;
            clientOutput_ = ByteString.EMPTY;
            myKey_ = ByteString.EMPTY;
            majorVersion_ = 1;
        ...
        public static final class Builder extends
            ...
            public Builder mergeFrom(ServerState.StoredServerPaymentChannel other) {
                if (other == ServerState.StoredServerPaymentChannel.getDefaultInstance())
                    return this;
             ...
             * <code>optional bytes bestValueSignature = 2;</code>
             */
            public Builder setBestValueSignature(ByteString value) {
                if (value == null) {
                    throw new NullPointerException();
                }
                bitField0_ |= 0x00000002;
             ...
             * <code>required bytes contractTransaction = 4;</code>
             */
            public Builder setContractTransaction(ByteString value) {
                if (value == null) {
                    throw new NullPointerException();
                }
                bitField0_ |= 0x00000008;
             ...
             * <code>optional bytes clientOutput = 5;</code>
             */
            public Builder setClientOutput(ByteString value) {
                if (value == null) {
                    throw new NullPointerException();
                }
                bitField0_ |= 0x00000010;
             ...
             * <code>required bytes myKey = 6;</code>
             */
            public Builder setMyKey(ByteString value) {
                if (value == null) {
                    throw new NullPointerException();
                }
                bitField0_ |= 0x00000020;
    ...
    static {
        java.lang.String[] descriptorData = {
                "\n storedserverpaymentchannel.proto\022\017paym" +
                        ...
                        "\021\n\tclientKey\030\010 \001(\014B.\n\037com.microbitcoin.mbcj.proto",
