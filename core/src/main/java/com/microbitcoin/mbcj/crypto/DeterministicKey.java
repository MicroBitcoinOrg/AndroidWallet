...
package com.microbitcoin.mbcj.crypto;
...
import com.microbitcoin.mbcj.core.Base58;
...
import static com.microbitcoin.mbcj.core.Utils.HEX;
...
public class DeterministicKey extends ECKey {
    ...
    /**
     * Returns this keys {@link com.microbitcoin.mbcj.crypto.KeyCrypter} <b>or</b> the keycrypter of its parent key.
     */
    @Override
    @Nullable
    ...
    private byte[] serialize(boolean pub) {
        ...
        if (this.parent == null) {
            ...
            ser.putInt(this.parent.getFingerprint());
        }
    ...
    public String serializePubB58() {
        return toBase58(this.serialize(true));
    }
     ...
     * in which case the time is stored alongside the key as per normal, see {@link com.microbitcoin.mbcj.core.ECKey#getCreationTimeSeconds()}.
     */
    @Override
